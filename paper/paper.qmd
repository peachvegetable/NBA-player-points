...
The estimand of this study, the total points a player scores, is predicted based on various processed performance metrics using lasso regression. This focus is importnat to achieving the study's goals of enhancing predictive precision and understanding how different metrics influence scoring in NBA games.

The paper is structured as follows: @sec-data covers the data collection and preparation methods; @sec-model explains the model setup, justification, and evaluation of its performance; @sec-results discusses the results; and @sec-discussion interprets these results in detail. Appendix provides additional data details, rounding out the discussion and ensuring thorough documentation of all methods and analyses used.
...
#| tbl-cap: "Top 5 NBA Players by Predictors Highly Correlated with Points, 2023-2024 Season"
...
#| tbl-cap: Top 10 NBA Players by selected statistics, Season 2023-2024
...
Our findings reveal that minutes played, turnovers, total rebounds, and personal fouls hold substantial predictive power for determining a player's total points. These variables contribute significantly to a player’s performance score, with minutes played emerging as a particularly potent predictor as shown in @sec-results. This aligns with the intuitive understanding that more time on the court allows for more opportunities to score. However, apart from the key predictors we've discussed through the whole paper, let's explore those less important variables.
